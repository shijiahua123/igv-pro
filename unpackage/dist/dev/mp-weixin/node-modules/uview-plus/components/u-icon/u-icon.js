...
const _sfc_main = {
  ...
  beforeCreate() {
    common_vendor.index.loadFontFace({
      ...
      fail() {
        common_vendor.index.__f__("error", "at node_modules/uview-plus/components/u-icon/u-icon.vue:98", "内置字体图标加载出错");
      }
    });
    if (common_vendor.config.customIcon.family) {
      common_vendor.index.loadFontFace({
        ...
        fail() {
          common_vendor.index.__f__("error", "at node_modules/uview-plus/components/u-icon/u-icon.vue:109", "扩展字体图标加载出错");
        }
      });
    }
  },
