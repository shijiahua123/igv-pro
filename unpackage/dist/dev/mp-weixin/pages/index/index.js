...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const closeMapConfig = () => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:284", "关闭图层");
    ...
    const handleRelocate = async () => {
      try {
        ...
        mapContext.value.moveToLocation({
          ...
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/index/index.vue:671", "移动到当前位置失败：", err);
            common_vendor.index.showToast({
              title: "定位失败，请重试",
              icon: "none"
            });
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:679", "重新定位失败：", err);
        common_vendor.index.showToast({
          title: "定位失败，请重试",
          icon: "none"
        });
    ...
    const handleSave = () => {
      ...
      common_vendor.index.__f__("log", "at pages/index/index.vue:704", "保存标记数据：", markData);
      common_vendor.index.showToast({
        title: "保存成功",
        icon: "success"
      });
    ...
    const checkPermission = () => {
      return new Promise((resolve, reject) => {
        common_vendor.index.getSetting({
          ...
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/index/index.vue:727", "获取设置失败：", err);
            reject(err);
          }
        });
      });
    ...
    const requestPermission = () => {
      return new Promise((resolve, reject) => {
        common_vendor.index.authorize({
          ...
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/index/index.vue:743", "权限请求失败：", err);
    ...
    const getLocationInfo = () => {
      return new Promise((resolve, reject) => {
        common_vendor.index.getLocation({
          ...
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/index/index.vue:781", "获取位置失败：", err);
            reject(err);
          }
        });
      });
    ...
    const getCurrentLocation = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:816", "位置服务异常：", err);
        error.value = "获取位置失败，请检查定位服务是否开启";
        isLoading.value = false;
      }
    };
    const handleRegionChange = (e) => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:824", "地图区域改变", e);
    };
    const handleMapUpdated = (e) => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:829", "地图更新完成", e);
      isLoading.value = false;
    };
    const handleMapError = (e) => {
      common_vendor.index.__f__("error", "at pages/index/index.vue:835", "地图加载错误：", e);
    ...
    const handleLayerClick = () => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:847", "点击图层按钮");
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        b: error.value,
        s: common_vendor.o(handleLayerClick),
        t: common_vendor.o(handleSearch),
        v: common_vendor.o(handleRelocate),
